...
namespace Lotus
{
	namespace ISUD
	{
		...
		/// </summary>
		//-------------------------------------------------------------------------------------------------------------
		public class CISUDDocument : CNameableID, IEquatable<CISUDDocument>, IComparable<CISUDDocument>
		{
			...
			protected static PropertyChangedEventArgs PropertyArgsViewCodeType = new PropertyChangedEventArgs(nameof(ViewCodeType));
			protected static PropertyChangedEventArgs PropertyArgsViewCodeStatus = new PropertyChangedEventArgs(nameof(ViewCodeStatus));
			#endregion
			...
			// Служебные данные
			internal Int32 mViewCodeType = 0;
			internal Int32 mViewCodeStatus = 0;
			#endregion
			...
			/// </summary>
			[Browsable(false)]
			public Int32 ViewCodeType
			{
				get { return (mViewCodeType); }
			}
			...
			/// </summary>
			[Browsable(false)]
			public Int32 ViewCodeStatus
			{
				get { return (mViewCodeStatus); }
			}
			...
			//---------------------------------------------------------------------------------------------------------
			public CISUDDocument(String name)
				:base(name)
			{
			}
			#endregion
			...
			//---------------------------------------------------------------------------------------------------------
			public Boolean Equals(CISUDDocument other)
			{
				return (ID == other.ID);
			}
			...
			//---------------------------------------------------------------------------------------------------------
			public Int32 CompareTo(CISUDDocument other)
			{
				return (0);
			}
			#endregion
			...
			////---------------------------------------------------------------------------------------------------------
			//public override IBaseElement CreateElement(String type_name, String element_name)
			//{
			...
			///// </summary>
			////---------------------------------------------------------------------------------------------------------
			//public override void GroupElements()
			//{
			...
			////---------------------------------------------------------------------------------------------------------
			//protected override void WriteBaseDocumentToAttribute(XmlWriter xml_writer)
			//{
			//	xml_writer.WriteStartElement("ISUDDocument");
			...
			////---------------------------------------------------------------------------------------------------------
			//protected override void ReadBaseDocumentFromAttribute(XmlReader xml_reader)
			//{
